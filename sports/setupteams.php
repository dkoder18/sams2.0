...
<html>
     ...
     <body>
          ...
          <div class = "jumbotron">
               <strong class="text-center"><h1>Team Sports Event Preferences</h1></strong>
          </div>
                              ...
                              <div class="card-body">
                                   ...
                                   <table class="table table-bordered table-responsive-md table-striped text-center">
                                        ...
                                        <tr>
                                             ...
                                             <td id="event1name" class="pt-3-half" contenteditable="true">3 x 3 Basketball Div 1</td>
                                        ...
                                        <tr>
                                             ...
                                             <td id="event2name" class="pt-3-half" contenteditable="true">3 x 3 Basketball Div 2</td>
                                        ...
                                        <tr>
                                             ...
                                             <td id="event3name" class="pt-3-half" contenteditable="true">3 x 3 Basketball Women</td>
