...
<html>
    <head>
        ...
        <style>
            ...
            #form1_submit{
                ...
                â€ƒpadding:0.7em 1.7em;
                â€ƒmargin:0 0.3em 0.3em 0;
                â€ƒborder-radius:0.2em;
                ...
                #form1_submit:active{
                â€ƒbox-shadow:inset 0 0.6em 2em -0.3em rgba(0,0,0,0.15),inset 0 0 0em 0.05em rgba(255,255,255,0.12);
                }
                @media all and (max-width:30em){
                â€ƒ#form1_submit{
                â€ƒâ€ƒdisplay:block;
                â€ƒâ€ƒmargin:0.4em auto;
                â€ƒ}
            }
    ...
    <body>
        ...
        <div class = "jumbotron">
            ...
            <strong><h1>Search for Athlete</h1></strong>
        </div>
