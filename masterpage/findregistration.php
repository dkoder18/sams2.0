...
<html>
     ...
     <body>
          ...
          <div class = "jumbotron">
               <center><strong><h1>Find Registration</h1></strong></center>
          </div>
     ...
     <script>
        ...
        function populateForm(data){
            ...
            console.log(lines);      // corresponding value of the columns
            
            var dict = {};
            for(var i = 1; i < lines.length - 1; i++){
            var info = lines[i].split(/,+(?=(?:(?:[^"]*"){2})*[^"]*$)/g);
            dict[info[0]] = info[2] + " " + info[3]
            }
